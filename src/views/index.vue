...
export default {
    ...
    methods: {
        ...
        run(container) {
            ...
            //获取元素
            this.box = document.getElementsByClassName('ball');
            //获取文档可视区域的宽高
        ...
        play() {
            const box = document.getElementsByClassName('ball');
            //获取元素
            if (!box) {
                return;
            }
            for (let i = 0; i < 3; i++) {
                ...
                let startTop = ball && ball.offsetTop;
                let startLift = ball && ball.offsetLeft;
                //startTop都为零；
